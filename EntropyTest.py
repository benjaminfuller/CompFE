...
def entropy(templates, ground_truth,num_jobs=4,positions=[],start=0,num_runs=10):
    ...
    print ("Average Entropy", avg_ent, " Minimum Entropy", (-1 * math.log(max(entropy_list))))
...
# Command Line Usage:
# python3 CompFE_fast.py [subset size] [number of subsets] [file name for positions] [number of runs] [start index]
