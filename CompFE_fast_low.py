...
if stopping_condition == 'size':
    ...
    print ("Starting HIGH gen and rep for alpha", str(alpha_param), "Subset size",str(size_or_threshold),"and", str(150000),"subsets")
    ...
    print ("Matched Indicies over TPR:", set(high_all_matches), "With lockers: ", 150000)
